...
class SheetReader:  # Of cause, the Reader can write, too.
    ...
    def write_book_header(self, workbook):
        ...
        sheet0.write(3, 0, 'Note: Required metadata fields are colored gold, while optional fields are orange. Metadata required connections are colored purple, optional connections are blue. To create a connection, specify the accession (user or system) of the object you wish to link to.')
